...
// Source provides random data for property testing with integrated shrinking support.
...
// NewSource creates a new Source with the given seed for deterministic generation.
...
// NewSourceFromData creates a Source that replays from the given byte stream.
// This is used during shrinking and reproduction.
func NewSourceFromData(data []byte) *Source {
...
func (s *Source) DrawBits(n int) uint64 {
	if n <= 0 || n > 64 {
