...
// This file contains generated matchers for User.
//
// Use UserMatches() to build type-safe matchers for assertions,
// or use User().AsEqualMatcher() for partial matching based on recipes.
