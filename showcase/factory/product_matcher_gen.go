...
// This file contains generated matchers for Product.
//
// Use ProductMatches() to build type-safe matchers for assertions,
// or use Product().AsEqualMatcher() for partial matching based on recipes.
