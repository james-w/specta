...
// This file contains generated matchers for Order.
//
// Use OrderMatches() to build type-safe matchers for assertions,
// or use Order().AsEqualMatcher() for partial matching based on recipes.
